...
$sql="INSERT INTO product (Name, Price, Description, Img_location, Weight, S_Name, Stock_Level, Min_Level, Active)
VALUES
('$_POST[Name]','$_POST[Price]','$_POST[Description]','$_POST[Img_location]','$_POST[Weight]
